...
class UserProfile(models.Model):
    ...
    def _generate_unique_nickname(self, base: str | None = None) -> str:
        """
        Try to derive a CI-safe slug from base (username/email local-part).
        When collision/too short -> fallback to random u-xxxxxxx.
        """
        # normalize base to allowed charset
